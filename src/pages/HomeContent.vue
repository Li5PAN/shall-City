  ...
  <div>
    ...
    <section class="recommend-section">
      <div class="section-tabs">
        ...
        <a class="tab-more" @click="$router.push('/home/bounty')">更多需求 &gt;</a>
      </div>
      <div class="bounty-grid">
        <div v-for="bounty in bountyList" :key="bounty.id" class="bounty-card" @click="$router.push(`/home/bounty/${bounty.id}`)">
          <div class="bounty-card__top">
            <div v-if="bounty.coverImage" class="bounty-card__icon"><img :src="bounty.coverImage" :alt="bounty.title" /></div>
...
<script setup>
import { ref } from 'vue'
import { EyeOutlined, StarOutlined, RightOutlined, UserOutlined, LikeOutlined } from '@ant-design/icons-vue'
...
.bounty-grid {
  ...
  .bounty-card {
    ...
    &__icon { width: 48px; height: 48px; border-radius: 8px; overflow: hidden; flex-shrink: 0; img { width: 100%; height: 100%; object-fit: cover; } }
    &__content { flex: 1; min-width: 0; }
    &__title { font-size: 14px; font-weight: 600; color: #333; margin: 0 0 4px; overflow: hidden; text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; }
